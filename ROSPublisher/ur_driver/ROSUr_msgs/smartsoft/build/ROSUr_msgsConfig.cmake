...
IF(EXISTS ${CMAKE_CURRENT_LIST_DIR}/CMakeCache.txt)
	...
	FOREACH(DEPENDENCY IN ITEMS SmartXml)
...
INCLUDE(${CMAKE_CURRENT_LIST_DIR}/ROSUr_msgsTargets.cmake)

# the following variables are depricated and should not be used anymore:
# ROSUr_msgs_LIBRARIES
# ROSUr_msgs_INCLUDES

# instead, just directly link the library ROSUr_msgs to your executable target like this:
#
# TARGET_LINK_LIBRARIES(YourExecutableTarget ROSUr_msgs)
#
# (all the includes and additional libraries are automatically determined from the target ROSUr_msgs)
