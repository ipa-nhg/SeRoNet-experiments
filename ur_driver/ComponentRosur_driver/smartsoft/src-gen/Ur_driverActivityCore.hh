...
//--------------------------------------------------------------------------
#ifndef _UR_DRIVERACTIVITY_CORE_HH
#define _UR_DRIVERACTIVITY_CORE_HH
...
protected:
	...
	Smart::StatusCode joint_statesOutPut(ROSCommon_msgs::Sensor_msgs_JointState &joint_statesOutDataObject);
...
private:
	...
	std::list<Ur_driverActivityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(Ur_driverActivityObserverInterface *observer);
	void detach_interaction_observer(Ur_driverActivityObserverInterface *observer);

public:
	Ur_driverActivityCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~Ur_driverActivityCore();
